...
-- content_json holds { sections, blocks } — the same rich alternating-image/
-- text structure ServiceSection.jsx and ContentBlocks.jsx already render.
CREATE TABLE IF NOT EXISTS services (
  id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
  slug VARCHAR(255) NOT NULL UNIQUE,
  nav_title VARCHAR(150) NOT NULL,
  card_title VARCHAR(150) NOT NULL,
  card_text VARCHAR(255) DEFAULT '',
